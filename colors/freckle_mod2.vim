" Vim color file
" Converted from Textmate theme Freckle (custom) using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Freckle (custom)"

hi Cursor  guifg=NONE guibg=#3592a8 gui=NONE
hi Visual  guifg=NONE guibg=#abd9e2 gui=NONE
hi CursorLine  guifg=NONE guibg=#b4b8bc gui=NONE
hi CursorColumn  guifg=NONE guibg=#b4b8bc gui=NONE
...
hi NonText  guifg=#404040 guibg=#b4b8bc gui=NONE
...
hi SpecialKey  guifg=#404040 guibg=#b4b8bc gui=NONE
