" Vim color file
" Converted from Textmate theme Summer Sun using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Summer Sun"

hi Cursor  guifg=NONE guibg=#f2f8cb gui=NONE
hi Visual  guifg=NONE guibg=#44402f gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#44402f gui=NONE
...
hi Folded  guifg=#645f47 guibg=#110f0a gui=NONE
...
hi Comment  guifg=#645f47 guibg=NONE gui=italic
...
hi NonText  guifg=#7c7558 guibg=#14120b gui=NONE
...
hi SpecialKey  guifg=#7c7558 guibg=#14120b gui=NONE
...
hi Todo  guifg=#645f47 guibg=NONE gui=inverse,bold,italic
...
hi rubyRailsARAssociationMethod  guifg=#a3ed4e guibg=NONE gui=NONE
hi rubyRailsARMethod  guifg=#a3ed4e guibg=NONE gui=NONE
hi rubyRailsRenderMethod  guifg=#a3ed4e guibg=NONE gui=NONE
hi rubyRailsMethod  guifg=#a3ed4e guibg=NONE gui=NONE
hi erubyDelimiter  guifg=NONE guibg=NONE gui=NONE
hi erubyComment  guifg=#645f47 guibg=NONE gui=italic
hi erubyRailsMethod  guifg=#a3ed4e guibg=NONE gui=NONE
hi htmlTag  guifg=#eef890 guibg=NONE gui=NONE
hi htmlEndTag  guifg=#eef890 guibg=NONE gui=NONE
hi htmlTagName  guifg=#eef890 guibg=NONE gui=NONE
hi htmlArg  guifg=#eef890 guibg=NONE gui=NONE
hi htmlSpecialChar  guifg=#3a94dc guibg=NONE gui=NONE
hi javaScriptFunction  guifg=#a3ed4e guibg=NONE gui=NONE
hi javaScriptRailsFunction  guifg=#a3ed4e guibg=NONE gui=NONE
...
hi cssFunctionName  guifg=#a3ed4e guibg=NONE gui=NONE
hi cssColor  guifg=#3a94dc guibg=NONE gui=NONE
hi cssPseudoClassId  guifg=#f8bb00 guibg=NONE gui=italic
hi cssClassName  guifg=#f8bb00 guibg=NONE gui=italic
hi cssValueLength  guifg=#3fa2ed guibg=NONE gui=NONE
hi cssCommonAttr  guifg=#f35e18 guibg=NONE gui=NONE
