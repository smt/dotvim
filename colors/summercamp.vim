" Vim color file
" Converted from Textmate theme Summer Camp Daybreak using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Summer Camp Daybreak"

hi Cursor  guifg=NONE guibg=#f2f8cb gui=NONE
hi Visual  guifg=NONE guibg=#292516 gui=NONE
hi CursorLine  guifg=NONE guibg=#221e12 gui=NONE
hi CursorColumn  guifg=NONE guibg=#221e12 gui=NONE
...
hi Pmenu  guifg=#97ef0c guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#292516 gui=NONE
hi IncSearch  guifg=NONE guibg=#3d590b gui=NONE
hi Search  guifg=NONE guibg=#3d590b gui=NONE
hi Directory  guifg=#3a94dc guibg=NONE gui=NONE
hi Folded  guifg=#5b522d guibg=#110f0a gui=NONE
...
hi Comment  guifg=#5b522d guibg=NONE gui=italic
...
hi NonText  guifg=#f3771d guibg=#221e12 gui=NONE
...
hi SpecialKey  guifg=#f3771d guibg=#221e12 gui=NONE
...
hi Tag  guifg=#97ef0c guibg=NONE gui=NONE
hi Title  guifg=#f2f8cb guibg=NONE gui=bold
hi Todo  guifg=#5b522d guibg=NONE gui=inverse,bold,italic
...
hi erubyComment  guifg=#5b522d guibg=NONE gui=italic
hi erubyRailsMethod  guifg=NONE guibg=NONE gui=NONE
hi htmlTag  guifg=#97ef0c guibg=NONE gui=NONE
hi htmlEndTag  guifg=#97ef0c guibg=NONE gui=NONE
hi htmlTagName  guifg=#97ef0c guibg=NONE gui=NONE
hi htmlArg  guifg=#97ef0c guibg=NONE gui=NONE
...
hi yamlKey  guifg=#97ef0c guibg=NONE gui=NONE
...
hi cssPseudoClassId  guifg=#97ef0c guibg=NONE gui=NONE
hi cssClassName  guifg=#97ef0c guibg=NONE gui=NONE
